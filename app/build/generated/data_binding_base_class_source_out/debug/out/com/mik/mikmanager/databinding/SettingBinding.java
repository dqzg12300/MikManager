...
public final class SettingBinding implements ViewBinding {
  ...
  private SettingBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textSlideshow) {
  ...
  public static SettingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SettingBinding((ConstraintLayout) rootView, textSlideshow);
    }
